...
#[derive(Debug)]
pub struct BlockSphereProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BlockSphereProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BlockSphere processing");
    
    let mut processor = BlockSphereProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BlockSphereProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BlockSphereProcessor::new(false);
